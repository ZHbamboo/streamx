...
create table `t_flink_env` (
  ...
  `flink_conf` text collate utf8mb4_general_ci not null comment 'flink-conf informationdefault value''',
...
create table `t_menu` (
  `menu_id` bigint not null auto_increment comment 'list/button id',
  `parent_id` bigint not null comment 'parent list id',
  `menu_name` varchar(50) collate utf8mb4_general_ci not null comment 'list button name',
  ...
  `type` char(2) collate utf8mb4_general_ci default null comment 'type 0:list 1:button',
  `display` char(2) collate utf8mb4_general_ci not null default 1 comment 'whether the list is displayed',
...
create table `t_flink_cluster` (
  ...
  `options` text comment 'parameter collections json form',
...
create table `t_alert_config` (
  ...
  `email_params` varchar(255) collate utf8mb4_general_ci comment 'email alert configuration',
  `sms_params` text collate utf8mb4_general_ci comment 'sms alert configuration',
  `ding_talk_params` text collate utf8mb4_general_ci comment 'ding talk alert configuration',
  `we_com_params` varchar(255) collate utf8mb4_general_ci comment 'wechat alert configuration',
  `http_callback_params` text collate utf8mb4_general_ci comment 'http callback alert configuration',
  `lark_params` text collate utf8mb4_general_ci comment 'lark alert configuration',
